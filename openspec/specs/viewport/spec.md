...
Defines viewport behavior for the weaving-scheme canvas: zoom range,
zoom step, cursor anchoring, adaptive rendering at extreme zoom, view
culling, fit-to-view, and session-only viewport persistence.
